defmodule CaHeoShopWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use CaHeoShopWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import CaHeoShopWeb.ConnCase
    end
  end

  setup tags do
    CaHeoShop.DataCase.setup_sandbox(tags)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = CaHeoShop.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    CaHeoShop.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
